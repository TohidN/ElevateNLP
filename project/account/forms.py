...
class SignupForm(forms.Form):
    ...
    email = forms.EmailField(
        widget=forms.TextInput(attrs={"placeholder": _("Email"), "class": "required"}),
        label=_("Email"),
    )
    ...
    def clean_username(self):
        ...
        try:
            ...
            if AccountSignup.objects.filter(
                user__username__iexact=self.cleaned_data["username"]
            ).exclude(activation_key="active"):
...
class EditAccountForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kw):
        ...
        self.fields["username"].widget.attrs = {
            "before_addon": _("fa fa-user"),
        }
        self.fields["email"].widget.attrs = {
            "before_addon": _("fa fa-envelope-o"),
        }
        self.fields["first_name"].widget.attrs = {
            "before_addon": _("fa fa-user-o"),
        }
        self.fields["last_name"].widget.attrs = {
            "before_addon": _("fa fa-user-o"),
        }
        self.fields["password"].widget.attrs = {
            "before_addon": _("fa fa-eye-slash "),
        }
    ...
    def clean_password(self):
        ...
        if 8 > len(password) > 0:
            raise forms.ValidationError(
                "This Password is too short. it must be at least 8 characters."
            )
        else:
            return password
    ...
    def save(self, commit=True):
        ...
        EditAccountForm.Meta.fields = tuple(
            x for x in EditAccountForm.Meta.fields if x != "password"
        )
